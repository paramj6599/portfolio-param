const projects = [
    ...
    },
    {
      ...
      title: "Gradvisor",
      description:
        "A recommendation system to suggest universities based on user profile and preferences.",
    ...
    },
    {
        ...
        title: "ResQVision",
        description:
          "An emergency response analytics dashboard for visualizing response times, incident types, severity, and infrastructure effectiveness across regions in Sydney using real-world data (IERAD).",
    ...
    },
    {
      ...
      title: "EpicCaptions",
      description:
        "Generates epic subtitles for videos using FFmpeg and LLM-enhanced processing.",
    ...
    },
    {
      ...
      description:
        "Data analysis project exploring trends and insights from startup funding data.",
