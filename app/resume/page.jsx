            ...
            <TabsContent value="skills" className="w-full h-full">
              <div className="flex flex-col gap-[30px]">
                ...
                {Object.values(skillsCategories).map((category, idx) => (
                  <div key={idx}>
                    <h4 className="text-3xl font-bold mt-6 mb-4">
                      {category.title}
                    </h4>
                    <ul className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 xl:gap-[30px]">
                      {category.skills.map((skill, index) => (
                        <li
                          key={index}
                          className="flex flex-col items-center justify-center w-full h-[180px] bg-[#232329] hover:text-accent rounded-xl duration-300"
                        >
